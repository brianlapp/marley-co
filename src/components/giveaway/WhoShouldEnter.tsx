      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white rounded-lg p-6">
            ...
            <h4 className="font-headline text-marley-dark mb-3">New and expecting parents who value quality and design</h4>
          ...
          <div className="bg-white rounded-lg p-6">
            ...
            <h4 className="font-headline text-marley-dark mb-3">Caregivers and grandparents looking for a great gift</h4>
            <p className="text-marley-primary">
          ...
          <div className="bg-white rounded-lg p-6">
            ...
            <h4 className="font-headline text-marley-dark mb-3">Any parent who wants an organized, stylish bag that outlives the diaper years</h4>
            <p className="text-marley-primary">
