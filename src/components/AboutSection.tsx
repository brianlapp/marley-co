    ...
    <section className="py-16 md:py-24 lg:py-32 px-4 bg-white">
      <div className="max-w-4xl mx-auto space-y-16 md:space-y-24 lg:space-y-32">
        <div className="space-y-6 md:space-y-8 lg:space-y-10 animate-fadeIn">
          ...
          <p className="text-lg sm:text-xl text-marley-primary/80 leading-relaxed max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="space-y-6 md:space-y-8 lg:space-y-10 animate-fadeIn" style={{ animationDelay: "0.4s" }}>
          ...
          <div className="space-y-6 md:space-y-8 text-lg sm:text-xl text-marley-primary/80 max-w-3xl mx-auto px-4 sm:px-6">
            ...
            <ul className="space-y-4 md:space-y-6 list-none pl-4 md:pl-8">
        ...
        <div className="space-y-6 md:space-y-8 lg:space-y-10 text-center animate-fadeIn" style={{ animationDelay: "0.6s" }}>
          ...
          <p className="text-lg sm:text-xl text-marley-primary/80 leading-relaxed max-w-2xl mx-auto px-4 sm:px-6">
